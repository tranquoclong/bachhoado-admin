...
// Note: This file only re-exports recharts components that are wrapped with theming/styling.
// Chart consumers should import chart primitives (AreaChart, LineChart, etc.) directly from recharts.
// This follows shadcn/ui's pattern: provide styled wrappers for common cases, allow direct library access for advanced cases.
